...
3) data/ (Optional: If the files are small or public, include them, otherwise mention where to get them or use .gitignore)
4) requirements.txt (List of libraries used: pandas, numpy, matplotlib, seaborn)
